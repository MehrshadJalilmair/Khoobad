...
class CheChizKojaCell: UITableViewCell {
    ...
    @IBOutlet weak var BizPhone: UILabel!//changed to distance
    ...
    private func updateUI()
    {
        ...
        BizRate.text = "\(self.homeBiz.Rate)"
        
        self.BizRate.textColor = UIColor.whiteColor()
        
        if Int(homeBiz.Rate) == 0
        {
            BizRate.text = "-/-"
        ...
        else if homeBiz.Rate >= 5 && homeBiz.Rate < 7
        {
            ...
            self.BizRate.layer.backgroundColor = UIColor(red: 255/255, green: 242/255, blue: 0/255, alpha: 1).colorWithAlphaComponent(1).CGColor
