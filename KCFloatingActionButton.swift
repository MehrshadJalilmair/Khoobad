...
//        setOverlayLayer()
    ...
    */
    ...
    private func setObserver() {
        ...
        NSNotificationCenter.defaultCenter().addObserver(self, selector: #selector(KCFloatingActionButton.keyboardWillHide), name:UIKeyboardWillHideNotification, object: nil)
    }
