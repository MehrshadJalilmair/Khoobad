...
class EMPartialModalViewController: UIViewController {
    ...
    var contentViewMaxHeight: CGFloat = UIScreen.mainScreen().bounds.height {
        didSet {
    ...
    override func viewDidLoad() {
        ...
        overlayView.addTarget(self, action: #selector(EMPartialModalViewController.dismissViewController), forControlEvents: UIControlEvents.TouchUpInside)
